...
/**
 * Helper that filter the amount of fields in a given object, just put to null
 * its values via set and get methods.
 *
...
public final class FieldsFilter {
    ...
    /**
     * Method that put null in each field that not is listed into the fields
     * String
     *
     * @param <T>
     * @param fields
     *            String of fields separated by "," or other character
     * @param list
     * @param separator
     *            A separator, if is null is ","
     * @return list
     * @since Apr 30, 2014
     *
     */
    public static <T> List<T> filterFields(final String fields,
	    final List<T> list, final String separator) {
     ...
     *
     * @param fields
     *            Fields separated with comma. It makes a trim so, spaces end
     *            and begin will be removed.
     * @param list
     * */
	...
	try {
	    ...
	    // Remove from map the field that we want to keep, anything else
	    // will set to null.
     ...
     *            list of fields on the Object to set to null
     * @param T
     * @throws NoSuchMethodException
     * */
    private static <T> void checkNullFields(
	    final Map<String, String> availableFields, final T club)
